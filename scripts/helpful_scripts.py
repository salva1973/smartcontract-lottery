...
def get_contract(contract_name):
  ...
  if defined, otherwise, it will deploy a mock version of tht contract, and
...
def fund_with_link(contract_address, account=None, link_token=None, amount=250000000000000000): # 0.1 Link                                                                           
